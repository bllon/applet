...
Page({
  ...
  returnBtn: function(event) {
    ...
    wx.request({
      url: 'http://localhost/LunWen/main/index.php/Admin/Lunwen/finish_return?return_id=' + id+'&&school='+school_name,
      method: 'GET',
      data: {
  ...
  onLoad: function() {
    ...
    wx.request({
      url: 'http://localhost/LunWen/main/index.php/Admin/Data/userBorrowList?consumer_unionid=' + consumer_unionid,
      method: 'POST',
      data: {
        school:school_name,
        consumer_unionid: consumer_unionid
